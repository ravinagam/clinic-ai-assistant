...
function LoginScreen({ onLogin }: { onLogin: (token: string, name: string, specialty: string) => void }) {
  ...
  return (
    <div style={{ minHeight: "60vh", display: "flex", alignItems: "center", justifyContent: "center" }}>
      <div style={{ background: "#fff", borderRadius: 16, padding: 36, boxShadow: "0 4px 24px rgba(0,0,0,0.10)", width: 360 }}>
        <div style={{ textAlign: "center", marginBottom: 28 }}>
          <div style={{ fontSize: 40, marginBottom: 8 }}>👨‍⚕️</div>
          <h2 style={{ fontSize: 20, fontWeight: 700, margin: 0 }}>Doctor Login</h2>
        ...
        <form onSubmit={submit} style={{ display: "flex", flexDirection: "column", gap: 14 }}>
          ...
          <div>
            ...
            <input
              ...
              required
              style={{ width: "100%", padding: "10px 12px", borderRadius: 8, border: "1px solid #e2e8f0", fontSize: 22, letterSpacing: 10, textAlign: "center", boxSizing: "border-box" }}
            />
          </div>
          ...
          <button
            ...
            style={{ background: "#2563eb", color: "#fff", border: "none", borderRadius: 8, padding: "12px", fontWeight: 700, fontSize: 15, cursor: "pointer", opacity: loading ? 0.7 : 1, marginTop: 4 }}
          >
    ...
    <div style={{
      ...
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start" }}>
        ...
        <div style={{ textAlign: "right" }}>
          <div style={{ fontWeight: 700, fontSize: 16, color: "#2563eb" }}>{time}</div>
      ...
      {editing && (
        <textarea
          ...
          rows={3}
          style={{ width: "100%", padding: "8px 12px", borderRadius: 8, border: "1px solid #e2e8f0", fontSize: 13, resize: "vertical", fontFamily: "inherit", boxSizing: "border-box" }}
        />
      )}
      ...
      {(status !== apt.status || notes !== (apt.notes || "")) && !saved && (
        <button
          onClick={save}
          disabled={saving}
          style={{ background: "#16a34a", color: "#fff", border: "none", borderRadius: 8, padding: "9px", fontWeight: 700, cursor: "pointer", fontSize: 13 }}
        >
  ...
  return (
    <div>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 16, marginBottom: 24 }}>
        {[
          { label: "Today", value: todayApts.length, color: "#2563eb" },
        ...
        Object.entries(grouped).map(([day, apts]) => (
          <div key={day} style={{ marginBottom: 24 }}>
            <div style={{ fontSize: 14, fontWeight: 700, color: "#475569", marginBottom: 10, display: "flex", alignItems: "center", gap: 8 }}>
              {day}
              {day === todayStr && <span style={{ background: "#dbeafe", color: "#2563eb", fontSize: 10, fontWeight: 700, padding: "2px 8px", borderRadius: 20 }}>TODAY</span>}
